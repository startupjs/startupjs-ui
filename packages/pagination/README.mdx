...
| --- | --- | --- |
| `--Pagination-item-size` | `2rem` | Controls the item size. |
| `--Pagination-item-padding-x` | `0.5rem` | Controls the horizontal item padding. |
| `--Pagination-page-selected-color` | `var(--color-primary)` | Controls the page selected color. |
| `--Pagination-status-gap` | `0.5rem` | Controls the status gap. |
| `--Pagination-icon-color` | `var(--color-secondary)` | Controls the icon color. |
| `--Pagination-icon-disabled-color` | `var(--color-muted-foreground)` | Controls the icon disabled color. |
