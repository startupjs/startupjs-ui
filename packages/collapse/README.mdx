...
| --- | --- | --- |
| `--Collapse-radius` | `var(--radius-md)` | Controls the radius. |
| `--Collapse-header-padding` | `1rem` | Controls the header padding. |
| `--Collapse-header-icon-gap` | `0.5rem` | Controls the header icon gap. |
| `--Collapse-content-padding-x` | `1rem` | Controls the horizontal content padding. |
| `--Collapse-content-padding-bottom` | `1rem` | Controls the content padding bottom. |
