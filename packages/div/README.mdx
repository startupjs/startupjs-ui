...
| --- | --- | --- |
| `--Div-hoverBg` | `color-mix(in srgb, var(--color-foreground) 5%, transparent)` | Controls the hover Bg. |
| `--Div-activeBg` | `color-mix(in srgb, var(--color-foreground) 20%, transparent)` | Controls the active Bg. |
| `--Div-tooltipBg` | `var(--color-popover-foreground)` | Controls the tooltip Bg. |
| `--Div-tooltipText` | `var(--color-popover)` | Controls the tooltip Text. |
