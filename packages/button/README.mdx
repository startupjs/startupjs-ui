...
The default color is `primary`. You can change it by passing any CSSX color token, such as `secondary`, `success`, `warning`, or `error`, to the `color` prop. Tokens resolve through variables like `--color-primary`.
