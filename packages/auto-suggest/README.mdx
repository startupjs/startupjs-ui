...
| --- | --- | --- |
| `--AutoSuggest-loader-min-height` | `4rem` | Controls the loader min height. |
| `--AutoSuggest-content-radius` | `var(--radius-md)` | Controls the content radius. |
| `--AutoSuggest-item-bg` | `color-mix(in srgb, var(--color-foreground) 5%, transparent)` | Controls the item background. |
| `--AutoSuggest-attachment-bg` | `var(--color-popover)` | Controls the attachment background. |
| `--AutoSuggest-attachment-radius` | `var(--radius-md)` | Controls the attachment radius. |
| `--AutoSuggest-attachment-shadow` | `var(--shadow-md)` | Controls the attachment shadow. |
