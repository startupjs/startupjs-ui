...
| --- | --- | --- |
| `--User-avatar-gap` | `0.5rem` | Controls the avatar gap. |
| `--User-name-font-size-m` | `var(--text-sm)` | Controls the medium name font size. |
| `--User-name-line-height-m` | `1.25rem` | Controls the medium name line height. |
| `--User-name-font-size-l` | `var(--text-base)` | Controls the large name font size. |
| `--User-name-line-height-l` | `1.5rem` | Controls the large name line height. |
| `--User-description-font-size-m` | `var(--text-xs)` | Controls the medium description font size. |
| `--User-description-line-height-m` | `1rem` | Controls the medium description line height. |
| `--User-description-font-size-l` | `var(--text-sm)` | Controls the large description font size. |
| `--User-description-line-height-l` | `1.25rem` | Controls the large description line height. |
