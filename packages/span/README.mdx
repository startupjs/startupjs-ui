...
| `--Span-line-height` | `1.428571` | Controls the line height multiplier. |
...
| `--Span-h1-line-height` | `1.333333` | Controls the h1 line height multiplier. |
| `--Span-h2-font-size` | `var(--text-5xl)` | Controls the h2 font size. |
| `--Span-h2-line-height` | `1.333333` | Controls the h2 line height multiplier. |
| `--Span-h3-font-size` | `var(--text-4xl)` | Controls the h3 font size. |
| `--Span-h3-line-height` | `1.333333` | Controls the h3 line height multiplier. |
| `--Span-h4-font-size` | `var(--text-2xl)` | Controls the h4 font size. |
| `--Span-h4-line-height` | `1.333333` | Controls the h4 line height multiplier. |
| `--Span-h5-font-size` | `var(--text-xl)` | Controls the h5 font size. |
| `--Span-h5-line-height` | `1.4` | Controls the h5 line height multiplier. |
| `--Span-h6-font-size` | `var(--text-base)` | Controls the h6 font size. |
| `--Span-h6-line-height` | `1.5` | Controls the h6 line height multiplier. |
