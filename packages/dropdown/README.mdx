...
Dropdown caption exposes CSSX variables for app-wide visual tuning:

- **--DropdownCaption-active-color** -- text color used by the active caption. It uses `var(--color-foreground)` by default.
