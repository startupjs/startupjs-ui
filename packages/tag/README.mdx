...
| --- | --- | --- |
| `--Tag-height-s` | `1.25rem` | Controls the small height. |
| `--Tag-height-m` | `1.5rem` | Controls the medium height. |
| `--Tag-padding-x-s` | `calc(var(--spacing) * 2)` | Controls the small padding horizontal. |
| `--Tag-padding-x-m` | `calc(var(--spacing) * 3)` | Controls the medium padding horizontal. |
| `--Tag-font-size-s` | `var(--text-xs)` | Controls the small font size. |
| `--Tag-line-height-s` | `1rem` | Controls the small line height. |
| `--Tag-font-size-m` | `var(--text-sm)` | Controls the medium font size. |
| `--Tag-line-height-m` | `1.25rem` | Controls the medium line height. |
| `--Tag-font-weight` | `var(--font-weight-normal)` | Controls the font weight. |
| `--Tag-icon-inside-margin-s` | `calc(var(--spacing) * 1.5)` | Controls the small icon inside margin. |
| `--Tag-icon-inside-margin-m` | `calc(var(--spacing) * 2)` | Controls the medium icon inside margin. |
| `--Tag-icon-outside-margin-s` | `calc(var(--spacing) * -0.5)` | Controls the small icon outside margin. |
| `--Tag-icon-outside-margin-m` | `calc(var(--spacing) * -1)` | Controls the medium icon outside margin. |
| `--Tag-outlined-border-width` | `1px` | Controls the outlined border width. |
| `--Tag-disabled-opacity` | `0.25` | Controls the disabled opacity. |
