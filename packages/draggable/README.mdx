...
| --- | --- | --- |
| `--Draggable-placeholder-bg` | `var(--color-muted)` | Controls the placeholder background. |
| `--Draggable-placeholder-radius` | `var(--radius-sm)` | Controls the placeholder radius. |
| `--Draggable-placeholder-min-height` | `2rem` | Controls the placeholder min height. |
